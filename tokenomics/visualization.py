...
def visualize_token_rate_vs_user_growth(hours, token_rates, total_bots, parameters=None):
    """
...
def create_visualizations(simulation_results, final_token_supply, ap_stats, parameters=None):
    """
    ...
    try:
        ...
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Total BOTs'], label='Total BOTs')
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Active BOTs'], label='Active BOTs')
        ...
        plt.subplot(4, 1, 1)
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Token Value (Theory)'])
        plt.ylabel('Token Value')
        plt.title('Token Value Over Time')
        plt.grid(True, alpha=0.3)
        
        plt.subplot(4, 1, 2)
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Tokens Sold'], 
                 label='Tokens Sold Per Round', color='red')
        plt.ylabel('Tokens Sold')
        plt.legend()
        plt.grid(True, alpha=0.3)
        
        plt.subplot(4, 1, 3)
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Tokens Purchased'], 
                 label='Tokens Purchased Per Round', color='green')
        plt.ylabel('Tokens Purchased')
        plt.legend()
        plt.grid(True, alpha=0.3)
        
        plt.subplot(4, 1, 4)
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Market Sentiment'], 
                 label='Market Sentiment', color='blue')
        ...
        for ap_type in parameters.AP_TYPES.keys():
            plt.plot(simulation_results['Cumulative Hours'], simulation_results[f"{ap_type}_Self_Points"], 
        ...
        plt.subplot(2, 1, 2)
        for ap_type in parameters.AP_TYPES.keys():
            plt.plot(simulation_results['Cumulative Hours'], simulation_results[f"{ap_type}_Giving_Points"], 
        ...
        token_supply_points = [parameters.INITIAL_TOKEN_SUPPLY + (final_token_supply - parameters.INITIAL_TOKEN_SUPPLY) * min(1.0, t / parameters.TARGET_HOURS) for t in time_points]
        ...
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['USD Value of Sold Tokens'], 
                 label='USD Sold', color='red')
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['USD Value of Purchased Tokens'], 
                 label='USD Purchased', color='green')
        ...
        plt.subplot(2, 1, 1)
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Annualized Inflation Rate'], 
                 label='Annualized Inflation', color='orange')
        ...
        plt.subplot(2, 1, 2)
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Market Cap (Theory)'])
        plt.xlabel('Cumulative Hours')
        ...
        valid_roi = simulation_results[~np.isinf(simulation_results['Minimum ROI Time (hours)'])]
        plt.plot(valid_roi['Cumulative Hours'], valid_roi['Minimum ROI Time (hours)'] / 24)  # Convert to days
        plt.xlabel('Cumulative Hours')
        ...
        plt.axhline(y=parameters.TEAM_BUYBACK_TOTAL, color='red', linestyle='--', 
        ...
        # Plot NFT price
        plt.figure(figsize=(14, 8))
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Current Round NFT Price'])
        plt.xlabel('Cumulative Hours')
        ...
        ax1.plot(simulation_results['Cumulative Hours'], simulation_results['Current Round NFT Price'], color=color)
        ax1.tick_params(axis='y', labelcolor=color)
        ...
        # Filter out infinite values
        valid_roi = simulation_results[~np.isinf(simulation_results['Minimum ROI Time (hours)'])]
        ax2.plot(valid_roi['Cumulative Hours'], valid_roi['Minimum ROI Time (hours)'] / 24, color=color)
        ax2.tick_params(axis='y', labelcolor=color)
        ...
        # Token burning graph
        plt.figure(figsize=(14, 8))
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Total Tokens Burned'], 
                 label='Tokens Burned Per Round', color='purple')
        plt.xlabel('Cumulative Hours')
        ...
        plt.figure(figsize=(14, 8))
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['Additional AP Tokens Spent'], 
                 label='AP Purchase', color='blue')
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['External POST Tokens Spent'], 
                 label='External POST', color='green')
        plt.xlabel('Cumulative Hours')
        ...
        token_supply_points = parameters.INITIAL_TOKEN_SUPPLY + simulation_results['NBT Issued'].cumsum() - cumulative_burned
        
        plt.plot(time_points, token_supply_points, label='Adjusted Token Supply', color='blue')
        plt.plot(time_points, parameters.INITIAL_TOKEN_SUPPLY + simulation_results['NBT Issued'].cumsum(), 
                 label='Token Supply without Burning', color='red', linestyle='--')
        plt.plot(time_points, cumulative_burned, label='Cumulative Tokens Burned', color='green')
        
        plt.xlabel('Cumulative Hours')
        plt.ylabel('Tokens')
        plt.title('Token Supply vs Burning')
        plt.legend()
        plt.grid(True, alpha=0.3)
        plt.savefig('token_supply_vs_burning.png')
        
        # Token value vs burn rate relationship
        plt.figure(figsize=(14, 8))
        
        # Calculate burn rate at each point (total burned / total issued)
        total_issued = parameters.INITIAL_TOKEN_SUPPLY + simulation_results['NBT Issued'].cumsum()
        ...
        # Utility users count
        plt.figure(figsize=(14, 8))
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['AP Purchase Users'], 
                 label='AP Purchase Users', color='blue')
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['External POST Users'], 
                 label='External POST Users', color='green')
        plt.xlabel('Cumulative Hours')
        ...
        post_dau = simulation_results['Active BOTs'] * parameters.AP_TYPES['POST']['USAGE_PROB']
        # Add external POST users
        total_post_dau = post_dau + simulation_results['External POST Users']
        
        plt.plot(simulation_results['Cumulative Hours'], post_dau, 
                 label='BOT Users Using POST', color='blue')
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['External POST Users'], 
                 label='External POST Users', color='green')
        plt.plot(simulation_results['Cumulative Hours'], total_post_dau, 
                 label='Total POST DAU', color='red')
        plt.xlabel('Cumulative Hours')
        ...
        ax1.plot(simulation_results['Cumulative Hours'], simulation_results['External POST Users'], color=color)
        ax1.tick_params(axis='y', labelcolor=color)
        ...
        post_usage_usd = simulation_results['External POST Tokens Spent'] * simulation_results['Token Value (Theory)']
        ...
        plt.figure(figsize=(14, 8))
        plt.plot(simulation_results['Cumulative Hours'], simulation_results['AP Purchase Users'], 
                 label='Daily AP Purchase Users', color='purple')
        plt.xlabel('Cumulative Hours')
        plt.ylabel('Daily Active Users')
        ...
        ax1.plot(simulation_results['Cumulative Hours'], simulation_results['AP Purchase Users'], color=color)
        ax1.tick_params(axis='y', labelcolor=color)
        ...
        # Convert to USD using token value
        ap_purchase_usd = simulation_results['Additional AP Tokens Spent'] * simulation_results['Token Value (Theory)']
        ...
        for i in range(len(simulation_results)):
            if simulation_results['External POST Users'].iloc[i] > 0:
                post_per_transaction[i] = simulation_results['External POST Tokens Spent'].iloc[i] / simulation_results['External POST Users'].iloc[i]
                post_per_transaction_usd[i] = post_per_transaction[i] * simulation_results['Token Value (Theory)'].iloc[i]
        ...
        """
        plt.plot(simulation_results['Cumulative Hours'], post_per_transaction_usd, 
                 label='USD per POST', color='red')
        plt.xlabel('Cumulative Hours')
        ...
        for i in range(len(simulation_results)):
            if simulation_results['AP Purchase Users'].iloc[i] > 0:
                ap_per_transaction[i] = simulation_results['Additional AP Tokens Spent'].iloc[i] / simulation_results['AP Purchase Users'].iloc[i]
                ap_per_transaction_usd[i] = ap_per_transaction[i] * simulation_results['Token Value (Theory)'].iloc[i]
        ...
        """
        plt.plot(simulation_results['Cumulative Hours'], ap_per_transaction_usd, 
                 label='USD per AP Purchase', color='red')
        plt.xlabel('Cumulative Hours')
        ...
        # Plot round duration
        plt.figure(figsize=(14, 8))
        plt.plot(simulation_results['Round'], simulation_results['Round Duration (hours)'])
        plt.xlabel('Round')
        plt.ylabel('Round Duration (hours)')
        plt.title('Round Duration Over Time')
        plt.grid(True, alpha=0.3)
        plt.savefig('round_duration.png')
        
        print("Graphs saved: bot_growth.png, token_market_dynamics.png, ap_types_comparison.png, ap_types_pie_chart.png, token_supply.png, token_transaction_usd.png, inflation_market_cap.png, minimum_roi_time.png, team_buyback.png, nft_price.png, nft_price_vs_roi.png, token_rate_vs_users.png, round_duration.png")
        print("Additional graphs saved: token_burning.png, token_utility.png, cumulative_token_burning.png, token_supply_vs_burning.png, token_value_vs_burn.png, utility_users.png")
    except ImportError:
